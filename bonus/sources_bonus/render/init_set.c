...
/*   Updated: 2023/03/07 11:05:50 by wangthea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	init_textures(t_game *game)
{
	...
	xpm_bonus_hurt_up_player_get(game);
	xpm_bonus_hurt_down_player_get(game);
	xpm_bonus_hurt_left_player_get(game);
	xpm_bonus_hurt_right_player_get(game);
	xpm_hearts_get(game);
