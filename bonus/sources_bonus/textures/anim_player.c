...
/*   Updated: 2023/03/06 16:41:31 by twang            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	xpm_bonus_idle_player_get(t_game *g)
{
	...
	g->txtr.idle[3].sprite = mlx_xpm_file_to_image(g->set.mlx,
			"./assets/xpm/link00.xpm", &g->txtr.img_w, &g->txtr.img_h);
	g->txtr.idle[4].sprite = mlx_xpm_file_to_image(g->set.mlx,
			"./assets/xpm/link00.xpm", &g->txtr.img_w, &g->txtr.img_h);
	g->txtr.idle[5].sprite = mlx_xpm_file_to_image(g->set.mlx,
			"./assets/xpm/link00.xpm", &g->txtr.img_w, &g->txtr.img_h);
}
...
void	xpm_bonus_idle_left_player_get(t_game *g)
{
	...
	g->txtr.idle_left[3].sprite = mlx_xpm_file_to_image(g->set.mlx,
			"./assets/xpm/link_left00.xpm", &g->txtr.img_w, &g->txtr.img_h);
	g->txtr.idle_left[4].sprite = mlx_xpm_file_to_image(g->set.mlx,
			"./assets/xpm/link_left00.xpm", &g->txtr.img_w, &g->txtr.img_h);
	g->txtr.idle_left[5].sprite = mlx_xpm_file_to_image(g->set.mlx,
			"./assets/xpm/link_left00.xpm", &g->txtr.img_w, &g->txtr.img_h);
}
...
void	xpm_bonus_idle_right_player_get(t_game *g)
{
	...
	g->txtr.idle_right[3].sprite = mlx_xpm_file_to_image(g->set.mlx,
			"./assets/xpm/link_right00.xpm", &g->txtr.img_w, &g->txtr.img_h);
	g->txtr.idle_right[4].sprite = mlx_xpm_file_to_image(g->set.mlx,
			"./assets/xpm/link_right00.xpm", &g->txtr.img_w, &g->txtr.img_h);
	g->txtr.idle_right[5].sprite = mlx_xpm_file_to_image(g->set.mlx,
			"./assets/xpm/link_right00.xpm", &g->txtr.img_w, &g->txtr.img_h);
}
