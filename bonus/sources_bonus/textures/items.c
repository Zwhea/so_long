...
/*   Updated: 2023/03/06 11:25:34 by twang            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	xpm_items_get(t_game *g)
{
	...
	g->txtr.t_items.game_over = mlx_xpm_file_to_image(g->set.mlx,
			"./assets/xpm/lose.xpm", &g->txtr.img_w, &g->txtr.img_h);
}

void	xpm_hearts_get(t_game *g)
{
	g->txtr.hearts[0].sprite = mlx_xpm_file_to_image(g->set.mlx,
			"./assets/xpm/full_heart.xpm", &g->txtr.img_w, &g->txtr.img_h);
	g->txtr.hearts[1].sprite = mlx_xpm_file_to_image(g->set.mlx,
			"./assets/xpm/two_life.xpm", &g->txtr.img_w, &g->txtr.img_h);
	g->txtr.hearts[2].sprite = mlx_xpm_file_to_image(g->set.mlx,
			"./assets/xpm/one_heart.xpm", &g->txtr.img_w, &g->txtr.img_h);
}