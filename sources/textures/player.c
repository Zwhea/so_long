...
/*   Updated: 2023/02/25 23:51:38 by wangthea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	xpm_player_get(t_game *g)
{
	...
	g->txtr.t_player.link_o_exit = mlx_xpm_file_to_image(g->set.mlx,
			"./assets/xpm/link_o_exit.xpm", &g->txtr.img_w, &g->txtr.img_h);
}
